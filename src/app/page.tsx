...
const features = [
  {
    ...
    description: 'All messages and data are encrypted, ensuring that only the intended recipients can access and decipher them.',
    icon: LockClosedIcon,
  },

  {
    name: 'Secure Account Verification',
    description: 'Implement secure account verification methods, such as two-factor authentication, to protect user accounts from unauthorized access',
    icon: FingerPrintIcon,
  },

  {
    name: 'Disappearing Messages',
    description: 'Set messages to automatically disappear after a specified time to enhance privacy and prevent them from being stored indefinitely.',
    icon: ClockIcon,
  },

  {
    name: 'Self-Destructing Media',
    description: "Send photos, videos, and other media files that automatically delete from the recipient's device after a specified viewing time.",
    icon: PhotoIcon,
  },
];
      ...
      <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          ...
          <div className="flex lg:hidden">
            <button
              type="button"
              className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-black/70"
